   ...
   <div class="container" style="margin-top: 10px;">
     ...
     <div class="row">
       ...
       <div class="col-lg-12 mb-4">
         ...
         <br>
         <?php if($userOffer['status'] == 2 ||$userOffer['status'] == 3){?>
         ...
         <hr>
          <?php }else{?>
            <p style="font-size: 15px;"><b>E-Mail Address:</b><i> Select/Shrotlist Candidate to view this information.</i><br><b>Mobile Number:</b><i> Select/Shrotlist Candidate to view this information.</i><br><b>Location:</b><i> Select/Shrotlist Candidate to view this information.</i></p>
            <hr>
          <?php } ?>
...
which involves taking chances or risking interest of any department. You are fully aware of how the decisions and actions of one department affect the rest of the organization but you do not take risks in making decisions or requests for resources. This dimension is a subset of judgment. Although you are aware of &nbsp;the needs of the community as well as the needs, expectations or viewpoints of others but when it comes to taking risk in certain decisions you avoid it.&nbsp;</p>
     ...
     <p style="float: right; font-size: 12px;"><b>Note: </b><i class="fa fa-check-circle"></i> indicates a verified detail, verified by CampusPuppy. Details without <i class="fa fa-check-circle"></i> are claimed by the user and not verified by CampusPuppy</p>
     <div class="clearfix"></div>
